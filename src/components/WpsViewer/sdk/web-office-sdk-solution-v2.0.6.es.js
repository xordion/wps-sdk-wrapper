...
!(function (e) {
  ...
  (function (e) {
    (e.nomal = 'nomal'), (e.simple = 'simple'), (e.embed = 'embed');
  })(s || (s = {})),
  (function (e) {
    (e[(e.requestFullscreen = 1)] = 'requestFullscreen'),
      (e[(e.exitFullscreen = 0)] = 'exitFullscreen');
  })(r || (r = {}));
let l = window.navigator.userAgent.toLowerCase(),
  u = /iPhone|iPod|iPad/i.test(l);
function d(e) {
  if (!e) return !1;
...
let h = (function () {
    function e(e, t, n, i, s, r, o) {
      ...
      void 0 === s && (s = !0),
        ...
        (this.url = n),
        (this.mount = i),
        (this.isListenResize = s),
        (this.addedStyles = r),
        (this.customAttrs = o),
        (this.handleResize = function () {
          let e = a.mount,
            t = a.mountResizeObserver,
            n = e.clientHeight,
            i = e.clientWidth;
          0 !== n || 0 !== i || t
            ? (0 === n && 0 === i) || !t || (t.disconnect(), (t = null))
    ...
    return (
        ...
        u &&
          ...
          window.visualViewport.addEventListener('resize', function () {
            let t = window.visualViewport,
              n = t.width,
              i = t.height,
              s = document.body.clientHeight - e.iframe.clientHeight;
            e.instance.sendMsgToWps({
              eventName: 'visualViewportResize',
              data: { width: n, height: i - s },
            });
          }),
        i))
        ...
        return (
          ...
          (n.destroy = function () {
            window.removeEventListener('resize', e.handleResize),
              ...
              (n = null),
              e.mountResizeObserver &&
                (e.mountResizeObserver.disconnect(),
                (e.mountResizeObserver = null));
          }),
          n
        );
      }),
      ...
      (e.prototype.mergeAttrs = function (e) {
        let t = this.customAttrs;
        if (t && Object.keys(t).length && t.allow) {
          let n = t.allow instanceof Array ? t.allow : t.allow.split(';');
          n.unshift('clipboard-write'),
            n.unshift('clipboard-read'),
            (t.allow = n.join(';')),
            Object.assign(e, t);
        }
        return e;
  ...
  f = (function () {
    ...
    return (
      (e.prototype.add = function (e) {
        this.HANDLE_LIST.push(e), window.addEventListener('message', e, !1);
      }),
      (e.prototype.remove = function (e) {
        let t = this.HANDLE_LIST.indexOf(e);
        t >= 0 && this.HANDLE_LIST.splice(t, 1),
          window.removeEventListener('message', e, !1);
      }),
      (e.prototype.empty = function () {
        for (; this.HANDLE_LIST.length; ) {
          let e = this.HANDLE_LIST.shift();
          window.removeEventListener('message', e, !1);
        }
      }),
  ...
  p = (function () {
              ...
              switch (v.label) {
                ...
                case 1:
                  (d = v.sent()),
                    ...
                    (v.label = 2);
                case 2:
                  return e !== this.prefix + 'setter'
                    ? [3, 4]
                    : [4, this.handleApiSetter(t)];
                case 3:
                  v.sent(), (v.label = 4);
                case 4:
                  return (
                    (p = function () {
                      let t = function (l) {
                        return a(m, void 0, void 0, function () {
                          ...
                          return c(this, function (c) {
                            switch (c.label) {
                              case 0:
                                return this.instance.originWhiteList.includes(
                                  l.origin,
                                ) || this.origin === l.origin
                                  ? (a = this.message.parse(l.data))
                                      .eventName ===
                                      this.prefix + 'callback' &&
                                    a.callbackId &&
                                    u[a.callbackId]
                                    ? [4, u[a.callbackId].apply(u, a.data.args)]
                                    : [3, 2]
                                  : [2];
                              case 1:
                                (d = c.sent()),
                      ...
                      return m.message.add(t), l;
                    }),
                    this.handleSendApiChannel([
                      { eventName: e, data: t, msgId: n },
                      p,
                    ]),
                    [2, l]
                  );
            ...
            return c(this, function (c) {
              switch (c.label) {
                case 0:
                  return (
                    (t = function () {
                      return Object.keys(h.setterCallbacks.idMap).find(
                        function (e) {
                ...
                case 1:
                  return (
                    ...
                    null === s &&
                      ...
                      Object.keys(this.setterCallbacks.idMap).length ||
                        this.message.remove(
                          this.setterCallbackSubscribe.bind(this),
                        )),
                    l &&
                      (Object.keys(this.setterCallbacks.idMap).length ||
                        this.message.add(
    ...
    return (
      (e.prototype.destroyApplication = function () {
        (this.collectObjIdHandlers = new Set()), (this.objId = 0);
      }),
        ...
        this.message.add(function (e) {
          return a(n, void 0, void 0, function () {
            ...
            return c(this, function (c) {
              switch (c.label) {
                case 0:
                  return this.instance.originWhiteList.includes(e.origin) ||
                    this.origin === e.origin
                    ? ((t = this.message.parse(e.data)),
                      (n = t.sdkInstanceId),
                      t.eventName === this.prefix + 'event' &&
                      Number(n) === this.sdkInstanceId &&
                      t.data
                        ? ((s = t.data),
                          (r = s.eventName),
                          (o = s.data),
            ...
            set: function (e) {
              (i[r] = e),
                n.sendMsgToWps({
                  ...
                  data: { eventName: r, register: !!e, objId: (n.objId += 1) },
      ...
      (e.prototype.makeCollectObjIdHandle = function (e) {
        ...
        return function () {
          ...
          return (
            t.collectObjIdHandlers.add(i),
            {
              End: function () {
                e(n), t.collectObjIdHandlers.delete(i);
              },
            }
          );
        };
        ...
        for (
          var i = this,
            ...
            r = function () {
              let t = s.shift();
              !t.alias &&
                ~a.polyfillApi.indexOf(t.prop) &&
                s.push(o(o({}, t), { alias: t.prop + 'Async' })),
                    ...
                    if (!r) {
                      let o = i.getError(),
                        ...
                        c = function () {
                          ...
                          return (
                            void 0 !== t.caller
                              ? ((s = { objId: i.createObjId() }),
                                i.assign(s, n[t.caller], n))
                              : (s = {}),
                            i.wrapper(
                              c,
                              s,
                      ...
                      return (
                        (c.objId = -1),
                        void 0 !== t.getter &&
                          ((c.objId = a), i.assign(c, n[t.getter], n)),
                        i.wrapper(
                          e,
                          c,
                          i.prefix + 'getter',
      ...
      (e.prototype.wrapper = function (e, t, n, i, s, r) {
        let o,
          ...
          c = (e.done ? e.done() : Promise.resolve()).then(function () {
            return o || (o = a.apiChannel(n, i, s, r)), o;
          });
        (t.done = function () {
          return c;
        }),
              ...
              case 0:
                return this.instance.originWhiteList.includes(e.origin) ||
                  ...
                  ? ((t = this.message.parse(e.data)),
                    ...
                    (i = t.callbackId),
                    (s = t.data),
                    i && (r = this.setterCallbacks.idMap[i])
                      ? ((o = r.split(':')),
                        (a = o[0]),
                        (l = o[1]),
                        n === this.prefix + 'callback' &&
                        this.setterCallbacks[a] &&
                        this.setterCallbacks[a][l]
                          ? [
                              4,
                              (d = this.setterCallbacks[a][l]).callback.apply(
                                d,
                                s.args,
                              ),
                            ]
      ...
      (e.prototype.reduceArgs = function (e) {
        return a(this, void 0, void 0, function () {
          let t, n, i, s, r, o, a, l, u, h, f;
          return c(this, function (c) {
            switch (c.label) {
              case 0:
                (t = {}), (n = []), (i = e.slice(0)), (c.label = 1);
              case 1:
                return i.length ? ((s = void 0), [4, i.shift()]) : [3, 13];
              case 2:
              ...
              case 7:
                h && h.objId
                  ? (h = { objId: h.objId })
                  : 'function' === typeof h &&
                    ((f = this.getId()), (t[f] = h), (h = { callbackId: f })),
                  (c.label = 8);
              case 8:
                (s[u] = h), (c.label = 9);
              case 9:
              ...
              case 11:
                r && r.objId
                  ? (s = { objId: r.objId })
                  : 'function' === typeof r && void 0 === r.objId
                  ? ((f = this.getId()), (t[f] = r), (s = { callbackId: f }))
                  : (s = r),
                  (c.label = 12);
              case 12:
                return n.push(s), [3, 1];
      ...
      (e.prototype.createObjId = function (e) {
        return (this.objId += 1), !e && this.collectObjId(), this.objId;
      }),
  ...
  m = (function (e) {
    function n(t, n, s) {
      ...
      return (
        (o.Application = f),
        (o.Free = function (e) {
          return r.apiChannel(r.prefix + 'free', { objId: e }, '');
        }),
        (o.Stack = f.Stack =
          r.makeCollectObjIdHandle(function (e) {
            r.apiChannel(r.prefix + 'free', { objId: e }, '');
          })),
        (o.destroyApplication = function () {
          r.destroyApplication();
        }),
        r.subEventHandle(f.Sub, c),
        r.mixinProto(t, o),
        r
      );
    }
    ...
    function n(t, n, i) {
      ...
      return (
        ...
        (r.CommonFree = function (e) {
          return s.apiChannel(s.prefix + 'free', { objId: e }, '');
        }),
        (r.CommonStack = d.Stack =
          s.makeCollectObjIdHandle(function (e) {
            s.apiChannel(s.prefix + 'free', { objId: e }, '');
          })),
...
let b = (function () {
    function e(t) {
      ...
      (this.id = 0),
          ...
          { event: 'open.result' },
          {
            ...
            callback: function () {
              for (var e = [], t = 0; t < arguments.length; t++)
                e[t] = arguments[t];
              let n = e[0];
              return new m(i, n, 'api.'), i.Application;
            },
          },
          {
            ...
            callback: function () {
              for (var e = [], t = 0; t < arguments.length; t++)
                e[t] = arguments[t];
              let n = e[0];
              return new v(i, n, 'commonApi.'), i.CommonApi;
            },
          },
        ]),
        ...
        (this.polyfillConfigName = [
          ['wpsOptions', 'wordOptions'],
          ['etOptions', 'excelOptions'],
          ['wppOptions', 'pptOptions'],
        ]),
        (this.flag = {
          advancedApiReadySended: !1,
          advancedApiReadySendedJust: !1,
          commonApiReadySended: !1,
          commonApiReadySendedJust: !1,
        }),
        ...
        (this.handleBaseReady = function () {
          i.sendMsgToWps({
            eventName: 'setConfig',
            data: o(o({}, i.sdkConfig), { version: i.version }),
          }),
            i.tokenData &&
              i.setToken(
                o(o({}, i.tokenData), {
            ...
            i.flag.advancedApiReadySended &&
              i.sendMsgToWps({ eventName: 'api.ready' }),
            i.flag.commonApiReadySended &&
              i.sendMsgToWps({ eventName: 'commonApi.ready' }),
            (i.iframeReady = !0);
        }),
        (this.handleFullscreenChange = function () {
          let e = { status: r.requestFullscreen };
          document.fullscreenElement
            ? (e.status = r.requestFullscreen)
            : (e.status = r.exitFullscreen),
            i.sendMsgToWps({ data: e, eventName: 'fullscreenchange' });
        }),
    ...
    return (
            ...
            switch (t.label) {
              ...
              case 1:
                return (
                  t.sent(),
                  (this.tokenData = e),
                  this.sendMsgToWps({ eventName: 'setToken', data: e }),
                  [2]
                );
            }
          });
      ...
      (e.prototype.advancedApiReady = function () {
        return a(this, void 0, void 0, function () {
          return c(this, function (e) {
            switch (e.label) {
              case 0:
                return this.flag.advancedApiReadySendedJust
                  ? [3, 2]
                  : ((this.flag.advancedApiReadySendedJust = !0),
                    [4, this.fileOpenPromise]);
              case 1:
                e.sent(),
                  this.flag.advancedApiReadySended ||
                    ((this.flag.advancedApiReadySended = !0),
                    this.sendMsgToWps({ eventName: 'api.ready' })),
                  (e.label = 2);
              case 2:
      ...
      (e.prototype.commonApiReady = function () {
        return a(this, void 0, void 0, function () {
          return c(this, function (e) {
            switch (e.label) {
              case 0:
                return this.flag.commonApiReadySendedJust
                  ? [3, 2]
                  : ((this.flag.commonApiReadySendedJust = !0),
                    [4, this.basicReady()]);
              case 1:
                e.sent(),
                  this.flag.commonApiReadySended ||
                    ((this.flag.commonApiReadySended = !0),
                    this.sendMsgToWps({ eventName: 'commonApi.ready' })),
                  (e.label = 2);
              case 2:
      ...
      (e.prototype.handleConfig = function (e) {
        ...
        try {
          let i = this.userConfHandler(e),
            ...
            c = i.url,
            l = i.originWhiteList;
          (this.origin = (c.match(/https*:\/\/[^\/]+/g) || [])[0]),
            (this.originWhiteList = l || []);
          let u = this.readyEventNames.map(function (e) {
              return n.makeReady(e);
            }),
            d = u[0],
            f = u[1],
            p = u[2],
            m = u[3];
          (this.baseReadyPromise = d),
            (this.fileOpenPromise = f),
            (this.advancedReadyPromise = p),
            (this.commonApiPromise = m),
            (this.iframeWH = a
              ? { width: a.clientWidth + 'px', height: a.clientHeight + 'px' }
            ...
            (this.sdkConfig = i),
            (this.iframeInstance = new h(
              this,
              this.instanceId,
              c,
              a,
              null === (t = i.isListenResize) || void 0 === t || t,
              !1,
              { allow: i.attrAllow },
            )),
      ...
      (e.prototype.listener = function (e) {
        ...
        this.message.add(function (n) {
          return a(t, void 0, void 0, function () {
            let t, i, s, r, o, a, l, u, d;
            return c(this, function (c) {
              return (
                (t = this.message.parse(n.data)),
                (i = t.eventName),
                (s = void 0 === i ? '' : i),
                (r = t.data),
                (o = void 0 === r ? null : r),
                ...
                this.isOtherEvent(u)
                  ? [2]
                  : -1 !== ['wps.jssdk.api'].indexOf(s)
                  ? [2]
                  : ((d = this.handleListenEvent(s, o))
                      ? d()
                      : Object.keys(this.onEventNames).includes(s) &&
                        ('open.result' === s &&
                          (this.officeType = o.fileInfo.officeType),
            ...
            return a(s, void 0, void 0, function () {
              ...
              return c(this, function (c) {
                return (
                  ...
                  ((null === (o = this.sdkConfig.commonOptions) || void 0 === o
                    ? void 0
                    : o.isBrowserViewFullscreen) ||
                    (null === (a = this.sdkConfig.commonOptions) || void 0 === a
                      ? void 0
                      : a.isParentFullscreen)) &&
                    'fullscreenchange' === i &&
                    ((s = n.status),
                    (r = n.isDispatchEvent),
                    this.sdkConfig.commonOptions.isBrowserViewFullscreen
                      ? this.iframeWH &&
                        (function (e, t, n, i) {
                          0 === e
                            ? (t.style =
                        ...
                        })(s, this.iframe, this.iframeWH, r)
                      : this.sdkConfig.commonOptions.isParentFullscreen &&
                        (function (e, t) {
                          if (0 === e) {
                            let n = document,
                              i =
          ...
          return a(s, void 0, void 0, function () {
            ...
            return c(this, function (i) {
              switch (i.label) {
                ...
                case 4:
                  return (
                    this.sendMsgToWps({ eventName: e + '.reply', data: t }), [2]
                  );
              }
            });
          });
      ...
      (e.prototype.userConfHandler = function (e, t) {
        ...
        let r = o({}, e),
          ...
          k = r.readOnly;
        return (
          Object.assign(r, this.handleHeadersAndSubscriptionsConfig(c, u, t)),
          (r.url = this.handleUrlConfig(d, b, g, f, m, y, w, k)),
          d &&
          ...
          this.cbConfigs.map(function (e) {
            ...
            o &&
              ((t = o),
              (s = 'Function'),
              {}.toString.call(t) === '[object ' + s + ']') &&
              ((i.cbConfigsSub[e] = o), (r[e] = { eventName: n[e] }));
          }),
      ...
      (e.prototype.handleHeadersAndSubscriptionsConfig = function (e, t, n) {
        let i = e.backBtn,
          ...
          c = void 0 === a ? {} : a,
          l = [
            ['wpsconfig_back_btn', s],
            ['wpsconfig_share_btn', o],
            ['wpsconfig_other_menu_btn', c],
          ],
          u = [];
        return (
          c.items &&
            ...
            c.items.forEach(function (e, t) {
              void 0 === e && (e = {}),
                'custom' === e.type &&
                  u.push(['wpsconfig_other_menu_btn_' + t, e]);
            }),
      ...
      (e.prototype.handleUrlConfig = function (e, t, n, i, r, o, a, c) {
        ...
        l.push('sdkId=' + this.instanceId),
          t === s.simple || (e && !1 === e.isShowTopArea)
            ? l.push('simple', 'hidecmb')
            : t === s.embed && l.push('simple=1', 'hidecmb=1', 'embed=1'),
      ...
      (e.prototype.handleCommandBarsConfig = function (e, t) {
        ...
        return (
          t && this.sendMsgToWps({ data: n, eventName: 'setCommandBars' }), n
        );
      }),
      (e.prototype.sendMsgToWps = function (e) {
        let t,
          n,
          i = o(o({}, e), { sdkInstanceId: this.instanceId });
        null ===
          (n =
            null === (t = this.iframe) || void 0 === t
              ...
              : t.contentWindow) ||
          void 0 === n ||
          n.postMessage(JSON.stringify(i), this.realOrigin);
      }),
      (e.prototype.makeReady = function (e) {
        ...
        return new Promise(function (e) {
          let r = function (o) {
            if (
              ((t.realOrigin = o.origin),
              t.originWhiteList.includes(o.origin) || t.origin === o.origin)
            ) {
              let a = t.message.parse(o.data),
                c = a.eventName,
                l = a.data,
                u = a.sdkInstanceId;
  ...
  g = {
    executeCommandBar: 'ExecuteCommandBar',
    off: 'Off',
    save: 'Save',
    setCommandBars: 'SetCommandBars',
    setCooperUserColor: 'SetCooperUserColor',
    tabs: 'Tabs',
    Stack: 'Stack',
    WhenStacksEmpty: 'WhenStacksEmpty',
  };
function y(e, t) {
  let n = this;
  return (
      ...
      o(
        o(
          {},
          {
                        ...
                        switchTab: function (n) {
                          return a(t, void 0, void 0, function () {
                            return c(this, function (t) {
                              switch (t.label) {
                                case 0:
                                  return [4, e.commonApiReady()];
                                case 1:
                                  return (
                                    t.sent(),
                                    [4, e.CommonApi.Tabs.SwitchTab(n.tabKey)]
                                  );
                                case 2:
                                  return [2, t.sent()];
                              }
                          ...
                          return a(t, void 0, void 0, function () {
                            return c(this, function (t) {
                              switch (t.label) {
                                ...
                                case 1:
                                  return (
                                    t.sent(), [4, e.CommonApi.Tabs.GetTabs()]
                                  );
                                case 2:
                                  return [2, t.sent()];
                              }
                        ...
                        return c(this, function (n) {
                          switch (n.label) {
                            case 0:
                              return [4, e.commonApiReady()];
                            case 1:
                              return n.sent(), [4, e.commonApiPromise];
                            case 2:
                              return (
                                n.sent(),
                                'function' !== typeof e.CommonApi[i]
                                  ? [3, 4]
                                  : [4, e.CommonApi[i]()]
                              );
                            case 3:
            ...
            set: function (e, t, n) {
              return !!Reflect.has(e, t) && Reflect.set(e, t, n);
            },
          },
        ),
        t,
...
let k = (function (e) {
  ...
  return (
    ...
    (n.init = function (e) {
      let t = o({}, e);
      if ('string' === typeof t.mount) {
        let i = document.querySelector(t.mount);
        i
          ? (t.mount = i)
          : (console.warn('[WebOfficeSDK.init] mount挂载节点未找到'),
            delete t.mount);
      }
      if (t.url)
        throw Error(
      ...
      if (!t.appId || !t.fileId || !t.officeType)
        throw Error('[WebOfficeSDK.init] appId、fileId、officeType为必选项！');
      t.endpoint = t.endpoint || 'https://o.wpsgo.com';
      let s = new n(
        (function (e) {
          let t = o({}, e);
          t.token = t.token || t.fileToken;
          let n = t.appId,
            i = t.fileId,
            s = t.officeType,
            r = t.token,
            ...
            return c(this, function (o) {
              switch (o.label) {
                case 0:
                  return [4, e.commonApiReady()];
                case 1:
                  for (i in (o.sent(), (n = []), t)) n.push(i);
                  (s = 0), (o.label = 2);
                case 2:
                  if (!(s < n.length)) return [3, 11];
                  switch ((r = n[s])) {
                  ...
                  return [3, 9];
                case 3:
                  return [4, e.CommonApi.Hooks.Add('hyperLink')];
                case 4:
                  return (o.sent().OnAction = t[r]), [3, 10];
                case 5:
                  return [4, e.CommonApi.Hooks.Add('toast')];
                case 6:
                  return (o.sent().OnAction = t[r]), [3, 10];
                case 7:
                  return [4, e.CommonApi.Hooks.Add('getClipboardData')];
                case 8:
                  return (o.sent().OnAction = t[r]), [3, 10];
                case 9:
                  return [3, 10];
